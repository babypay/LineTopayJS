...
var myStaff = ['u49f93172b8c8865683dd2d47ccbb8613']; //Taro Mid Yang Mau Dijadiin Staff/Wakil Admin

const myAdmin = ['u5a225e2d66b7d8a44815ada6c8539daa']; //Mid Lu Supaya Jadi Admin

const myAssist = ['']; //Mid Bot Lu Jika Ada Bot 2 Atau Lebih

const myBot = ['ue9272b5edf7ae7e2d0e03edc8e7b599f']; //Taro Mid Bot Lu Kesini (Maksud Gw Bot Yang Pake Sc Ini)
const BoT = ['ue9272b5edf7ae7e2d0e03edc8e7b599f']
...
await this._sendMessage(seq,mentions.names.join(''))
        ...
        if(txt == 'anu' && this.sendRata == 0 && isAdmin(seq.from_)) {
           this.sendRata = 1;
           this._sendMessage(seq, 'Anu apa [Yes] or [No] ( ´･ω･`)');
         }
        ...
        if(txt == 'anu' && this.sendRata == 0 && isStaff(seq.from_)) {
           this.sendRata = 1;
           this._sendMessage(seq, 'Anu apa [Yes] or [No] ( ´･ω･`)');
         }
